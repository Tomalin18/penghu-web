...
const WebPassengerInfoPage = () => {
  ...
  const handleNext = () => {
    if (isFormValid()) {
      ...
      router.push(`/web/purchase/payment?${queryParams.toString()}`)
    }
  }
  ...
  // Calculate order summary for sidebar
  const getOrderSummary = () => {
    ...
    return { ticketBreakdown, totalAmount }
  }
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Passenger Count */}
              <div>
                <h2 className="font-semibold text-xl text-foreground mb-4">乘客人數</h2>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border-t pt-3 mt-3">
                          <div className="text-sm text-muted-foreground mb-2">票種明細</div>
                          <div className="space-y-2">
                            {orderSummary.ticketBreakdown &&
                              Object.entries(orderSummary.ticketBreakdown).map(([ticketType, details]: [string, any]) => (
                        ...
                        <div className="border-t pt-3 mt-3">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="font-bold text-primary text-xl">NT${orderSummary.totalAmount}</span>
                          </div>
                        </div>
                          ...
                          <div className="border-t pt-3 mt-3">
                            ...
                            <div className="space-y-3 max-h-[400px] overflow-y-auto">
                              {formData.map((passenger, index) => {
                                const hasData = passenger.name || passenger.ticketType || passenger.email || passenger.phone
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            >
              {(() => {
                ...
                if (termsMissing) return "請同意購票條款"
                return "下一步"
              })()}
            </Button>
          </div>
...
export default WebPassengerInfoPage
